...
def get_attendance_list(conditions, filters):
	attendance_list = frappe.db.sql("""select mr_employee as employee, day(date) as day_of_month,
		status from `tabMuster Roll Attendance` where docstatus = 1 %s order by mr_employee, date""" %
