			...
			if a.approver_status == 'Approved':
				...
				if cur:
					...
					try:
						...
						frappe.throw(_('<span style="color: red;">Muster Roll Application Row#{0}: For Employee <b>{1}({2})</b></span> error: {3}').format(a.idx,cid,a.person_name, e),title="Validation Error")
