frappe.ui.form.on("Semso Entry", {
    ...
    employee_group: function (frm) {
        if (!frm.doc.employee_group == "") {
            ...
            frm.set_df_property("number_of_people", "hidden", 0)
            frm.set_df_property("total_officer", "hidden", 0)
            frm.set_df_property("total_troops", "hidden", 0)
            frm.set_df_property("total_civilan", "hidden", 0)
        ...
        if (frm.doc.employee_group) {
            ...
            frm.set_df_property("number_of_people", "hidden", 1)
            frm.set_df_property("total_officer", "hidden", 1)
            frm.set_df_property("total_troops", "hidden", 1)
            frm.set_df_property("total_civilan", "hidden", 1)
