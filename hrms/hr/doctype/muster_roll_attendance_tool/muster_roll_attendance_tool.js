...
frappe.ui.form.on("Muster Roll Attendance Tool", {
	refresh(frm) {
    ...
    load_employees(frm) {
		...
		frappe
			.call({
				method: "hrms.hr.doctype.muster_roll_attendance_tool.muster_roll_attendance_tool.get_employees",
				args: {
					date: frm.doc.date,
    ...
    mark_attendance(frm) {
		...
		frappe
			.call({
				method: "hrms.hr.doctype.muster_roll_attendance_tool.muster_roll_attendance_tool.mark_employee_attendance",
				args: {
