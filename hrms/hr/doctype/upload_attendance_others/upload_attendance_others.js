...
erpnext.hr.MRAttendanceControlPanel = frappe.ui.form.Controller.extend({
	onload: function () {
	},
	...
	show_upload: function () {
		...
		frappe.upload.make({
			parent: $wrapper,
			args: {
				method: 'erpnext.hr.doctype.upload_attendance_others.upload_attendance_others.upload'
			},
...
cur_frm.cscript = new erpnext.hr.MRAttendanceControlPanel({ frm: cur_frm });