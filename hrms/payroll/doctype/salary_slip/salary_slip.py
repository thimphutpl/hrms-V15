...
class SalarySlip(TransactionBase):
    ...
    def pull_sal_struct(self):
        ...
        # frappe.throw(frappe.as_json(self.start_date)+" "+str(self.end_date))
    ...
    def set_salary_structure(self):
        ...
        # frappe.throw(frappe.as_json(self._salary_structure))
    ...
    def add_structure_components(self, component_type):
        ...
        for struct_row in self._salary_structure_doc.get(component_type):
            ...
            elif struct_row.salary_component=='Other Contribution':
                #frappe.throw(str(self.start_date))
                # if struct_row.to_date and struct_row.to_date <= self.end_date and struct_row.from_date and struct_row.from_date >= self.start_date :
                if (
                    struct_row.to_date
                    and getdate(struct_row.to_date) <= getdate(self.end_date)
                    and struct_row.from_date
                    ...
                    # frappe.throw(str(posting_date_obj))
                    self.add_structure_component(struct_row, component_type)
                #frappe.throw(str(struct_row.to_date))
    ...
    def compute_year_to_date(self):
        ...
        year_to_date += flt(self.net_pay)
        gross_year_to_date += flt(self.gross_pay)
    ...
    def compute_month_to_date(self):
        ...
        month_to_date += flt(self.net_pay)
